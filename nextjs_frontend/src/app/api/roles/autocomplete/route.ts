...
/**
 * Proxy for roles autocomplete API.
 *
 * Forwards incoming autocomplete queries to the backend Express API.
 *
 * Backend endpoint:
...
export async function GET(req: NextRequest) {
  ...
  try {
    const res = await fetch(`${backendUrl}/api/roles/autocomplete${query}`, {
      method: "GET",
      headers: {
